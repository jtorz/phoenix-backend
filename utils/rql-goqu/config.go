...
const (
	...
	ILIKE  = Op("ilike")  // ILIKE "PATTERN"
	NILIKE = Op("nilike") // NOT ILIKE "PATTERN"
...
type Config struct {
	...
	// It defaults to 25.
	DefaultLimit uint
	// UseDefault defines if the default value will be used if the unmarshalled value is zero.
	UseDefault bool
...
func (c *Config) defaults() error {
	...
	defaultUint(&c.DefaultLimit, DefaultLimit)
	defaultUint(&c.LimitMaxValue, DefaultMaxLimit)
	return nil
}
...
func defaultUint(i *uint, v uint) {
	if *i == 0 {
		*i = v
	}
}
